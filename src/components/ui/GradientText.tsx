...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative flex max-w-fit flex-row items-center font-medium transition-shadow duration-500 overflow-hidden cursor-pointer ${showBorder ? 'py-1 px-2' : ''} ${className}`}
