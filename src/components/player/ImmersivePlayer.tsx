...
export const ImmersivePlayer = ({ 
  ...
  return (
    <div 
      className={`fixed inset-0 z-50 w-full h-screen bg-[#05050A] flex overflow-hidden font-sans transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
    ...
    >
      ...
      <button 
        onClick={onClose}
        className="absolute top-12 left-12 z-50 w-12 h-12 flex items-center justify-center bg-white/5 hover:bg-white/10 rounded-full transition-colors backdrop-blur-md"
      >
